...
public class basics7 {
	...
	public void getData() throws IOException
	{
		...
		FileInputStream fis=new FileInputStream("C:\\Users\\test\\workspace\\DemoProject\\src\\files\\env.properties");
		prop.load(fis);
	...
	public void JiraAPICreateComment()
	{
		...
		RestAssured.baseURI= "webaddress";
...
"}").when().
	...
	public void AddBook()
	{
		...
		when().
		get("web/address+url").then().statusCode(200).extract().response();
